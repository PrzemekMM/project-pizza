...

{
  ...
  class Product{
    ...
    getElement(){
      const thisProduct = this;
      thisProduct.accordionTrigeer = thisProduct.element.querySelector(select.menuProduct.clickable);
    ...
    initAccordion(){
      ...
      thisProduct.accordionTrigeer.addEventListener('click', function(event){
        ...
        /* toggle avtive class n thisProduct.element */
    ...
    processOrder(){
      ...
      /*convert form to obcjet structure {sauce : ['tomato'], toppings: [olives, ...]}*/
